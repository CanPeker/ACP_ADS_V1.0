...
from acp_ads_interfaces.msg  import LaneRawData

#------------- ufld libs
import cv2
from perception_layer.ultrafastLaneDetector import UltrafastLaneDetector,ModelType
...
class LaneNode(Node):
    ...
    def __init__(self):
        ...
        self.model_path = "/home/canpeker/Desktop/ACP_ADS_V1.0/src/perception_layer/perception_layer/tusimple_18.pth" # local path ver unutma
